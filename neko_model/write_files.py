...
{spine_items}
  ...
  def write_toc_ncx(image_paths, book_uuid):
    ...
    </navPoint>''' for i in range(len(image_paths))])
...
{nav_points}
  ...
  def write_nav_xhtml(image_paths):
...
body {
  ...
  def add_html(image_paths, direction):
    ...
    max_width, max_height = Helpers.calculate_max_dimensions(image_paths)
