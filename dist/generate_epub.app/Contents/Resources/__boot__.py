...
_recipes_pil_prescript(['WebPImagePlugin', 'SpiderImagePlugin', 'GifImagePlugin', 'QoiImagePlugin', 'PalmImagePlugin', 'GribStubImagePlugin', 'FpxImagePlugin', 'DdsImagePlugin', 'PdfImagePlugin', 'FtexImagePlugin', 'XbmImagePlugin', 'PcdImagePlugin', 'TiffImagePlugin', 'PsdImagePlugin', 'IptcImagePlugin', 'CurImagePlugin', 'DcxImagePlugin', 'IcnsImagePlugin', 'Hdf5StubImagePlugin', 'XpmImagePlugin', 'MpegImagePlugin', 'FitsImagePlugin', 'McIdasImagePlugin', 'PcxImagePlugin', 'EpsImagePlugin', 'ImtImagePlugin', 'PngImagePlugin', 'PixarImagePlugin', 'FliImagePlugin', 'TgaImagePlugin', 'SgiImagePlugin', 'MspImagePlugin', 'PpmImagePlugin', 'BufrStubImagePlugin', 'WmfImagePlugin', 'BmpImagePlugin', 'JpegImagePlugin', 'MpoImagePlugin', 'Jpeg2KImagePlugin', 'XVThumbImagePlugin', 'MicImagePlugin', 'ImImagePlugin', 'GbrImagePlugin', 'BlpImagePlugin', 'IcoImagePlugin', 'SunImagePlugin'])
...
DEFAULT_SCRIPT='generate_epub.py'
SCRIPT_MAP={}
_run()
