...
_recipes_pil_prescript(['MpoImagePlugin', 'JpegImagePlugin', 'EpsImagePlugin', 'PalmImagePlugin', 'FitsImagePlugin', 'MpegImagePlugin', 'Jpeg2KImagePlugin', 'BufrStubImagePlugin', 'DdsImagePlugin', 'GifImagePlugin', 'FpxImagePlugin', 'Hdf5StubImagePlugin', 'SpiderImagePlugin', 'XbmImagePlugin', 'XVThumbImagePlugin', 'XpmImagePlugin', 'MicImagePlugin', 'QoiImagePlugin', 'DcxImagePlugin', 'CurImagePlugin', 'FliImagePlugin', 'McIdasImagePlugin', 'ImImagePlugin', 'PngImagePlugin', 'IcnsImagePlugin', 'BmpImagePlugin', 'BlpImagePlugin', 'WebPImagePlugin', 'SunImagePlugin', 'IcoImagePlugin', 'PixarImagePlugin', 'WmfImagePlugin', 'TiffImagePlugin', 'PpmImagePlugin', 'GbrImagePlugin', 'GribStubImagePlugin', 'IptcImagePlugin', 'PsdImagePlugin', 'MspImagePlugin', 'ImtImagePlugin', 'SgiImagePlugin', 'PdfImagePlugin', 'FtexImagePlugin', 'PcxImagePlugin', 'TgaImagePlugin', 'PcdImagePlugin'])
...
DEFAULT_SCRIPT='ePUBGenerator.py'
SCRIPT_MAP={}
_run()
